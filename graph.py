...
win_rate_self_df = pd.DataFrame(dict(
    iteration = iteration_win_rate_self,
    win_rate = win_rate_self
))
fig = px.line(win_rate_self_df, x="iteration", y="win_rate", title="Win rate self VS Iteration") 
fig.show()

win_rate_random_df = pd.DataFrame(dict(
    iteration = iteration_win_rate_random,
    win_rate = win_rate_random
))
fig = px.line(win_rate_random_df, x="iteration", y="win_rate", title="Win rate random VS Iteration") 
fig.show()

win_rate_greedy_df = pd.DataFrame(dict(
    iteration = iteration_win_rate_greedy,
    win_rate = win_rate_greedy
))
fig = px.line(win_rate_greedy_df, x="iteration", y="win_rate", title="Win rate greedy VS Iteration") 
fig.show()
...
pi_losses_df = pd.DataFrame(dict(
    episode = episodes,
    loss = pi_losses_data
))
